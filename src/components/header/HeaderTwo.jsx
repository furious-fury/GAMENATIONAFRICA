              ...
              <div className="row">
                ...
                <div className="mobile-nav-toggler two"><i className="fas fa-bars" /></div>
                  <div className="main-menu  menu-style-two">
                    <nav>
                      <div className="logo">
                        <Link to="/"><img src="https://fieryper.sirv.com/gamenation/logo/LOGO-N.png?w=50&format=webp&webp.fallback=png" alt="Logo" /></Link>
                      </div>
                 ...
                 <div className="mobile-menu">
                  <nav className="menu-box">
                    ...
                    <div className="nav-logo"><Link to="/"><img src="https://fieryper.sirv.com/gamenation/logo/LOGO-N.png?w=200&format=webp&webp.fallback=png" alt="" title='true' /></Link>
                    </div>
